...
var definitions = {
    ...
    faq: '/faq',
    calendar_months: '/api/calendar/months' + query('offer_id', 'package_id', 'origin', 'region', 'number_of_adults', 'number_of_children', 'number_of_infants', 'number_of_packages', 'provider*', 'match_surcharge'),
    calendar_days: '/api/calendar/days' + query('offer_id', 'package_id', 'origin', 'region', 'number_of_adults', 'number_of_children', 'number_of_infants', 'number_of_packages', 'provider*', 'match_surcharge'),
