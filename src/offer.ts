...
export const publicOfferPackages =
  "/api/v2/public-offers/{offerId}/packages{?brand,flightOrigin,checkIn,checkOut,occupancy*,region,medium}";
...
export const publicOfferList =
  "/api/v2/public-offers/list{?placeIds,occupancy,checkIn,checkOut,region,offerType,brand,sortBy,campaigns,holidayTypes,locations,strategyApplied,bounds,cancellationPolicies}";
